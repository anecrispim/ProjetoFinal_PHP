...
<?php include "menu.php"; ?>
    <div class="container">
        <form method="post">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <select name="filtro" class="form-select" id="filtro">
                            ...
                            <option value="TITULO" <?= isset($_POST['filtro']) && $_POST['filtro'] == 'TITULO' ? 'selected' : '' ?>>Título</option>
                            <option value="AUTOR" <?= isset($_POST['filtro']) && $_POST['filtro'] == 'AUTOR' ? 'selected' : '' ?>>Autor</option>
                            <option value="ISBN" <?= isset($_POST['filtro']) && $_POST['filtro'] == 'ISBN' ? 'selected' : '' ?>>ISBN</option>
                        </select>
                    </div>
                    <div class="col-sm-7">
            ...
            <br><br>
            <fieldset>
            <legend class="table-name">Livros</legend>
            <br><br>
                    ...
                    <?php
                        ...
                        $sTrCarros = '
                            <tr>
                                ...
                                <td>%s</td>
                                <td>
                                    <a type="button" class="btn btn-primary" style="width:50%%;" href="cadLivros.php?acao=alterar&id=%s">
                                ...
                                <td>
                                    <a type="button" class="btn btn-danger" style="width:50%%;" id="excluir" href=javascript:excluirRegistro("funcoes.php?acao=excluirL&id=%s")>
